...
- Explicitly block nonleader unit to prevents multi-unit deployments.

## 2026-09-2

### Added

- Added support for `strip-prefix` that is passed from the `ingress` relation.
...
- Added support for `gateway-route` relation in adapter mode.
